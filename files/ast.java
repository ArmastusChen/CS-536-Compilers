...
//  P6 implementation with codegen() methods
//  brett & brendon
//  CS536
// **********************************************************************
...
class ProgramNode extends ASTnode {
    ...
    public void nameAnalysis() {
        ...
        // check for main function in program
    ...
    // mirroring previously created methods in ProgramNode
...
class ExpListNode extends ASTnode {
    ...
    // codegen for each Expression node
    public void codeGen(String label) {
      for(ExpNode node : myExps) {
        node.codeGen("");
      }
...
class FnDeclNode extends DeclNode {
    ...
    public void codeGen(String label) {
      ...
      String returnLbl = Codegen.nextLabel();
      myBody.codeGen(returnLbl);

      Codegen.genLabel(returnLbl);
...
class PostIncStmtNode extends StmtNode {
    ...
    public void codeGen(String label) {
      ...
      if(((IdNode)myExp).sym().getOffset() == 0) {
          ...
          Codegen.generateIndexed("lw", Codegen.T0, Codegen.FP, ((IdNode)myExp).sym().getOffset());
          Codegen.generate("addi", Codegen.T0, Codegen.T0, 1);
...
class WriteStmtNode extends StmtNode {
    ...
    public void codeGen(String label) {
      ...
      } else if(myExp.typeCheck().isBoolType() || myExp.typeCheck().isIntType()){
...
class IfStmtNode extends StmtNode {
    ...
    public void codeGen(String label) {
      ...
      String brk = Codegen.nextLabel();
      Codegen.generate("beqz", Codegen.T0, brk);
      myDeclList.codeGen("");
      myStmtList.codeGen(label);

      Codegen.generateLabeled(brk, "", "");
    }
...
class IfElseStmtNode extends StmtNode {
    ...
    public void codeGen(String label) {
      ...
      String ifBrk = Codegen.nextLabel();
      String elseBrk = Codegen.nextLabel();

      //true
      Codegen.generate("beqz", Codegen.T0, ifBrk);
      myThenDeclList.codeGen("");
      myThenStmtList.codeGen(label);
      Codegen.generate("j", elseBrk);

      //else
      Codegen.genLabel(ifBrk);
      myElseDeclList.codeGen("");
      myElseStmtList.codeGen(label);

      Codegen.generateLabeled(elseBrk, "", "");
...
class WhileStmtNode extends StmtNode {
    ...
    public void codeGen(String label) {
      ...
      // get label name
      String label_start = Codegen.nextLabel();
      String label_exit = Codegen.nextLabel();

      Codegen.genLabel(label_start);
      ...
      // condition is false
      Codegen.generate("beqz", Codegen.T0, label_exit);
      myDeclList.codeGen("");
      myStmtList.codeGen(label);
      Codegen.generate("j", label_start);

      Codegen.generateLabeled(label_exit, "nop", "");
    }
...
class StringLitNode extends ExpNode {
    ...
    public void codeGen(String label) {
      Codegen.generate(".data");
      String tmp = Codegen.nextLabel();
      Codegen.generateLabeled(tmp, ".asciiz ", "", myStrVal);
      Codegen.generate(".text");
      Codegen.generate("la", Codegen.T0, tmp);
      Codegen.genPush(Codegen.T0);
  	}
...
class DotAccessExpNode extends ExpNode {
    ...
    //codeGen()
    // empty b/c we dont have to worry about dot
    // access of structs
    public void codeGen(String label) { }
...
class AssignNode extends ExpNode {
    ...
    public void codeGen(String label) {
      ...
      if(((IdNode)myLhs).sym().getOffset() == 0)
...
class AndNode extends LogicalExpNode {
    ...
    // codgen()
    public void codeGen(String label){
      String str1 = Codegen.nextLabel();
      String str2 = Codegen.nextLabel();
      myExp1.codeGen("");
      Codegen.genPop(Codegen.T0);
      Codegen.generate("beqz", Codegen.T0, str2);
      Codegen.genLabel(str1);
      myExp2.codeGen("");
      Codegen.genPop(Codegen.T0);
      Codegen.genLabel(str2);
      Codegen.genPush(Codegen.T0);
...
class OrNode extends LogicalExpNode {
    ...
    public void codeGen(String label){
      ...
      myExp1.codeGen("");
      Codegen.genPop(Codegen.T0);
      Codegen.generate("bnez", Codegen.T0, str2);
      Codegen.genLabel(str1);
      myExp2.codeGen("");
      Codegen.genPop(Codegen.T0);
      Codegen.genLabel(str2);
...
class EqualsNode extends EqualityExpNode {
    ...
    public void codeGen(String label){
        ...
        Codegen.genPop(Codegen.T0);
        Codegen.genPop(Codegen.T1);
        Codegen.generate("seq", Codegen.T0, Codegen.T0, Codegen.T1); //set equal to
        Codegen.genPush(Codegen.T0);
    }
}
...
class LessNode extends RelationalExpNode {
    ...
    public void codeGen(String label){
        ...
        Codegen.genPop(Codegen.T0);
        Codegen.genPop(Codegen.T1);
        Codegen.generate("slt", Codegen.T0, Codegen.T0, Codegen.T1); // set less than
        Codegen.genPush(Codegen.T0);
    }
...
class GreaterNode extends RelationalExpNode {
    ...
    public void codeGen(String label){
        ...
        Codegen.genPop(Codegen.T0);
        Codegen.genPop(Codegen.T1);
        Codegen.generate("sgt", Codegen.T0, Codegen.T0, Codegen.T1); // set greater than
        Codegen.genPush(Codegen.T0);
...
class LessEqNode extends RelationalExpNode {
    ...
    public void codeGen(String label){
        ...
        Codegen.genPop(Codegen.T0);
        Codegen.genPop(Codegen.T1);
        Codegen.generate("sle", Codegen.T0, Codegen.T0, Codegen.T1); //set less than or equal to
        Codegen.genPush(Codegen.T0);
...
class GreaterEqNode extends RelationalExpNode {
    ...
    public void codeGen(String label){
        ...
        Codegen.genPop(Codegen.T0);
        Codegen.genPop(Codegen.T1);
        Codegen.generate("sge", Codegen.T0, Codegen.T0, Codegen.T1); //set greater than or equal to
        Codegen.genPush(Codegen.T0);
    }
}
